                        ...
                        if( DataString == "Data" )
                        {
                            ...
                            if( KeyString.size( ) >= 5 && KeyString.substr( 0, 4 ) == "Hero" )
                            {
                                ...
                                if( Killer )
                                {
                                    ...
                                    {
                                    case 3:
                                        CONSOLE_Print("[STATS"+TypePrefix+"] "+Killer->GetName()+" is on a killing spree.");
                                        break;
                                    case 4:
                                        CONSOLE_Print("[STATS"+TypePrefix+"] "+Killer->GetName()+" is dominating.");
                                        break;
                                    case 5:
                                        CONSOLE_Print("[STATS"+TypePrefix+"] "+Killer->GetName()+" has a mega kill.");
                                        break;
                                    case 6:
                                        CONSOLE_Print("[STATS"+TypePrefix+"] "+Killer->GetName()+" is unstoppable.");
                                        break;
                                    case 7:
                                        CONSOLE_Print("[STATS"+TypePrefix+"] "+Killer->GetName()+" is wicked sick.");
                                        break;
                                    case 8:
                                        CONSOLE_Print("[STATS"+TypePrefix+"] "+Killer->GetName()+" has a monster kill.");
                                        break;
                                    case 9:
                                        CONSOLE_Print("[STATS"+TypePrefix+"] "+Killer->GetName()+" is godlike.");
                                        break;
                                    case 10:
                                        CONSOLE_Print("[STATS"+TypePrefix+"] "+Killer->GetName()+" is beyond godlike.");
                                        break;
                                    }
                                }
                                if( Killer && Victim )
					    ...
					    m_Game->BanPlayerByPenality( Killer->GetName(), Killer->GetExternalIPString(), m_Game->m_GHost->m_BotManagerName, Killer->GetPenalityLevel(), "FountainFarm" );
                            ...
                            else if( KeyString.size( ) >= 8 && KeyString.substr( 0, 5 ) == "Tower" )
                            {
                                ...
                                if( Level == "3" && m_Game->m_GHost->m_FountainFarmWarning ) {
                                    m_Game->SendAllChat( "["+m_Game->m_GHost->m_BotManagerName+"] "+m_Game->m_GHost->m_FountainFarmMessage );
                                }
                                if( Killer ) {
